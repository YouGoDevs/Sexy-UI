...
In our opinion, this structure makes it easier to account for private and global components without conflicting locations--feel free to let us know if you disagree!
...
For every React component created, there should be component props defined using an interface. Example:
...
We also avoid confusing patterns by creating separate files for each component's needs and by exclusively exporting only `ONE` component per file.
